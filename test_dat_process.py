...
# 读取图像数据
with gzip.open('org_data/t10k-images-idx3-ubyte.gz') as all_img:
    all_img = all_img.read()

# 读取标签数据
with gzip.open('org_data/t10k-labels-idx1-ubyte.gz') as all_lbl:
...
for i in range(num_images):
    ...
    img.save(f'data/test_img/{i}.jpg')
# breakpoint()
